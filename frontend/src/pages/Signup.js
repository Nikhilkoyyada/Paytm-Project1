  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(response.data.message === "Email already taken / Incorrect inputs") {
        toast.error("Email already taken / Incorrect inputs");
      ...
      <Card style={{ width: 450, padding: '1.5rem', borderRadius: '0.5rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', backgroundColor: 'rgba(192, 213, 224, 0)', backdropFilter: 'blur(20px)', webkitBackdropFilter: 'blur(20px)' }}>
        <CardContent>
          <form onSubmit={handleSubmit}>
            <h1 style={{ fontSize: '3xl', fontWeight: 'semibold', textAlign: 'center', color: 'rgba(107, 114, 128, 1)', marginBottom: 0 }}>Sign Up <span style={{ color: 'rgba(59, 130, 246, 1)' }}> Paytm</span></h1>
            <TextField
              name="firstName"
              label="First Name"
              variant="standard"
